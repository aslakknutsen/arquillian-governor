...
public class GithubGovernorConfiguration extends Configuration
{
    ...
    private static final String DEFAULT_GITHUB_REOPEN_MESSAGE = "This github issue was automatically opened by %s with Arquillian Governor github extension because test class [%s] method [%s] failed with %s.";
    ...
    private boolean reopenFailed = resolveReopenFailed();
    ...
    public void setReopenFailed(boolean reopenFailed)
    {
        setProperty("reopenFailed", Boolean.toString(reopenFailed));
    }

    public boolean getReopenFailed()
    {
        return Boolean.parseBoolean(getProperty("reopenFailed", Boolean.toString(reopenFailed)));
    }
    ...
    {
        return getProperty("reopeningMessage", DEFAULT_GITHUB_REOPEN_MESSAGE);
    }
    ...
    public void validate() throws GovernorConfigurationException
    {
        ...
        {
            throw new GovernorConfigurationException("Repository User and Repository name are not set - it is an empty String.");
        }
    ...
    public String toString()
    {
        ...
        sb.append(String.format("%-40s %s\n", "reopenFailed", getReopenFailed()));
        sb.append(String.format("%-40s %s\n", "closingMessage", getClosingMessage()));
        sb.append(String.format("%-40s %s\n", "reopeningMessage", getReopenMessage()));
    ...
    private boolean resolveReopenFailed()
    {
        return Boolean.valueOf(System.getProperty("github.governor.reopenfailed"));
    }
}
